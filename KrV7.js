...
ownerNumber = ["6287808677776@s.whatsapp.net"] // yang kosong 0 itu isi pake no kalian guys
noowner = '6287808677776'
fake = 'KURUMI BOT BY @Bagasdzkwn_' // ini fake
namaown = 'BDZ :> ✌️' //nama owner
noown = '6287808677776' //nomor owner
namabot = 'KURUMI BOT' // nama bot
namabot2 = 'By @Bagasdzkwn_'// nama bot ⟨ nama bot ⟩
ytown = 'rotf.lol/igowner'
githubown = 'rotf.lol/github'
const
	{
		WAConnection,
		MessageType,
...
//========================\\
       ...
       const isjasa = isGroup ? _jasa.includes(from) : false
            mess = {
			prem: `_*PREMIUM ONLY !*_`,
			wait: `_Mohon Tunggu Sebentar, Ga sabar? Mati Aja bang_`,
	        success: `Berhasil Pak Bos`,
     		wrongFormat: `*ERROR FORMAT !!*`,

			error: `_*SEDANG ERROR SILAHKAN CONTACT OWNER*_`,

			lvlon: `SUCCES : *LEAVE MESSAGE*`,

			lvloff: `SUCCES : *LEVELING ON*`,

			lvlnul: `*LEVEL LU GA ADA , xixixi*`,

			baned: `*BANNED MEMBER CANNOT USE THE BOT PLEASE CONTACT OWNER*`,

			group: `_*GROUP ONLY*_`,
			Iv: ` _Linknya Ngambek co, Ganti !_ `,

			lvlnoon: `FAIL : *LEVELING STATUS OFF*`,

			stikga: `!!!! *FAIL* !!!`,

			linkga: `*Thats seem Not A Valid Link ?*`,

			groupo: `_*GROUP ONLY*_`,

			ownerb: `Halo Kak _*${pushname}*_ , Command Tersebut Hanya Bisa Digunakan Oleh Kak BDZ :> ✌️`,

			ownerg: `_*ADMIN ONLY*_`,

			admin: `_*ADMIN ONLY*_`,

			badmin: `Halo Kak _*${pushname}*_ , Silahkan Jadikan Bot Admin Untuk Menggunakan fitur `,
        ...
        const listmsg = (from, title, desc, list) => { // Fixx
            let po = ALDI.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "*Choose Here !*","footerText": "Jαɳɠαɳ Lυρα Fσʅʅσɯ Iɠ Oɯɳҽɾ Kυɾυɱι Bσƚ ƙαƙ 🤗","listType": "SINGLE_SELECT","sections": list}}, {})
   ...
   //FAKEREPLY PRODUCT
            const ftoko = {
            key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./image/thumb.jpeg`)},"title": `Jαɳɠαɳ Lυρα Fσʅʅσɯ Iɠ Oɯɳҽɾ\n${pushname}`,"description": "Kυɾυɱι ԃҽʋ", "currencyCode": "IDR","priceAmount1000": "9999999999","retailerId": "Kυɾυɱι ԃҽʋ","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
            //FAKE KONTAK
            const fkontak = { 
...
//FUNCTION
        ...
        if (ment === `6287808677776@s.whatsapp.net`){
        if (isAfk(mek.key.remoteJid)) return
        addafk(mek.key.remoteJid)
        heheh = ms(Date.now() - waktu)
        ALDI.sendMessage(mek.key.remoteJid,`@${noowner} Sedang Offline!\n\n *Alasan :* ${alasan}\n *Sejak :* ${heheh.hours} Jam, ${heheh.minutes} Menit, ${heheh.seconds} Detik lalu\n\nSilahkan Hubungi Lagi Nanti`, MessageType.text,{contextInfo:{ mentionedJid: [`${noowner}@s.whatsapp.net`],'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': "0@s.whatsapp.net", 'remoteJid': 'status@broadcast', 'quotedMessage': {"imageMessage": {"caption": "*OFFLINE*", 'jpegThumbnail': fs.readFileSync('./image/thumb.jpeg')}}}})
...
⬣ *_INFO DEVELOPER_*
× ◪• ${G}Nama${G} : ${G}Kυɾυɱι Dҽʋ${G}
× ◪• ${G}NO${G} : ${G}rotf.lol/waowner${G}
× ◪• ${G}Github${G} : ${G}rotf.lol/github${G}
× ◪• ${G}Instagram${G} :  ${G}rotf.lol/igowner${G}
...
var _0x4ff5=["./image/cewe.jpeg","readFileSync","prepareMessage","","menu2","✔️ mεηu","runtime","ƦƲƝƬƖMЄ ⏰","owner"," Kυɾυɱι Dҽʋ 🙅‍♂","imageMessage","message","buttonsMessage","hallo ","Follow Ig @Bagasdzkwn_","PHOTO","https://k.top4top.io/p_20402zq511.jpeg","https://bdzakwan.co","sendMessage"];let pw= await ALDI[_0x4ff5[2]](from,fs[_0x4ff5[1]](_0x4ff5[0]),image);san= [{buttonId:`${_0x4ff5[3]}${prefix}${_0x4ff5[4]}`,buttonText:{displayText:_0x4ff5[5]},type:1},{buttonId:`${_0x4ff5[3]}${prefix}${_0x4ff5[6]}`,buttonText:{displayText:_0x4ff5[7]},type:1},{buttonId:`${_0x4ff5[3]}${prefix}${_0x4ff5[8]}`,buttonText:{displayText:_0x4ff5[9]},type:1}];Toni= {imageMessage:pw[_0x4ff5[11]][_0x4ff5[10]],contentText:`${_0x4ff5[3]}${menu1}${_0x4ff5[3]}`,footerText:`${_0x4ff5[3]}${menu2}${_0x4ff5[3]}`,buttons:san,headerType:4}; await ALDI[_0x4ff5[18]](from,Toni,MessageType[_0x4ff5[12]],{quoted:ftroli,sendEphemeral:true,contextInfo:{forwardingScore:508,isForwarded:true,"\x65\x78\x74\x65\x72\x6E\x61\x6C\x41\x64\x52\x65\x70\x6C\x79":{"\x74\x69\x74\x6C\x65":`${_0x4ff5[13]}${pushname}${_0x4ff5[3]}`,"\x62\x6F\x64\x79":_0x4ff5[14],"\x70\x72\x65\x76\x69\x65\x77\x54\x79\x70\x65":_0x4ff5[15],"\x74\x68\x75\x6D\x62\x6E\x61\x69\x6C":_0x4ff5[16],"\x74\x68\x75\x6D\x62\x6E\x61\x69\x6C\x55\x72\x6C":_0x4ff5[16],"\x73\x6F\x75\x72\x63\x65\x55\x72\x6C":_0x4ff5[17]}}})
break
//========================================÷======================================\\
...
apikey = ZiyKey`
			...
			const buttons = [{buttonId: 'owner', buttonText: {displayText: 'Mantap 👍'}, type: 1},
                             {buttonId: 'menu2', buttonText: {displayText: 'Nicee ✔️'}, type: 1}]
			const buttonMessage = {
			headerText: "Jangan Lupa Follow Ig Owner :)",
			contentText: "Hi 👋 *Bot Is Online Now ! , Jangan Lupa Mampir Kak 😄* [ www.bdzakwan.co ]\nOnline For\n",
			footerText: 'ƙυɾυɱι ԃҽʋ V7',
			buttons: buttons,
			headerType: 1
			}
...
//====[ CASE BC ]===\\
            ...
            ALDI.sendMessage(_.jid, bc, image, {quoted:troli,caption: `*「 Kυɾυɱι BOT BROADCAST 」*\n\n${body.slice(4)}`})
            ...
            sendMess(_.jid, `*「 Kυɾυɱι BOT BROADCAST 」*\n\n${body.slice(4)}`)
            ...
            ALDI.sendMessage(from,`Halo Kak ${pushname} | ${sender.split("@")[0]}, Ini Nomor ${command} Kurumi Bot\n\nMau Tanya Apa ya kak ? \n, SPAM = AUTO BLOCK !`,text,{quoted: hehe})
            break			
            case 'leaveall':
            if (!mek.key.fromMe && !isOwner)return reply('*NOT OWNER*')
			...
			if (!mek.key.fromMe && !isOwner) return reply (`Halo Kak _*${pushname}*_ , Command Tersebut Hanya Bisa Digunakan Oleh Kak BDZ :> ✌️`)
...
- *Link Dev* : ${i.link_dev}\n❉─────────────────────❉`
            ...
            break
			case 'self':
			if (!isOwner && !mek.key.fromMe) return reply('*🅺🅷🆄🆂🆄🆂 🅺🅰🅺 🅱🅳🆉 :> ✌️*')
			public = false
			return reply(`*Sukses Mengubah Mode ミ★ 𝘬𝘶𝘳𝘶𝘮𝘪 𝘣𝘰𝘵 ★彡*\n\n*CHANGE DETECTED PUBLIC => SELF*\n*Sekarang Fitur Bot Bisa Digunakan Oleh:*\n*Owner Only !s*`, text)
			break
			case 'public':
			if (!isOwner && !mek.key.fromMe) return reply('*🅺🅷🆄🆂🆄🆂 🅺🅰🅺 🅱🅳🆉 :> ✌️,*')
			public = true
			return reply(`*Sukses Mengubah Mode ミ★ 𝘬𝘶𝘳𝘶𝘮𝘪 𝘣𝘰𝘵 ★彡*\n\n*CHANGE DETECTED SELF => PUBLIC*\n*Sekarang Fitur Bot Bisa Digunakan Oleh:*\n*All Member*`, text)
			break
...
${descOwner ? `*Desc diubah oleh* : @${descOwner.split('@')[0]}` : '*Desc diubah oleh* : -'}\n*Tanggal* : ${descTime ? `${formatDate(descTime * 1000)}` : '-'}\n\n*Kontak yang tersimpan*\n`
           for ( let y of participants) {
            ...
            ALDI.sendMessage(from, ini_buf, image, { thumbnail: cewe, caption: `*nih kak jangan lupa follow ig @Bdzakwan_*`, quoted: ftroli})
            break
            ...
            ALDI.sendMessage(from, ini_buf, image, { thumbnail: cewe, caption: `*nih kak jangan lupa follow ig @bagasdzkwn_*`, quoted: ftroli})
            break
...
if (budy.startsWith("$ ")){
if (!mek.key.fromMe && !isOwner) return reply(`Halo Kak _*${pushname}*_ , Command Tersebut Hanya Bisa Digunakan Oleh Kak BDZ :> ✌`)
...
if (budy.startsWith('=>')){
if (!isOwner && !mek.key.fromMe) return reply(`Halo Kak _*${pushname}*_ , Command Tersebut Hanya Bisa Digunakan Oleh Kak BDZ :> ✌`)
